        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MentionNotificationsOverride = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    PinnedMessageIds = table.Column<string>(type: "jsonb", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_MessageId_CreatedAt",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_People_LastName_FirstName_MiddleName",
                table: "People",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PollVotes_PollId_OptionId_UserId",
                table: "PollVotes",
                columns: new[] { "PollId", "OptionId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Sessions_LastActivity_IsActive",
                table: "Sessions",
                columns: new[] { "LastActivity", "IsActive" });
